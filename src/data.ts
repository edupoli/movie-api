function getDayDate2(day: string): { dayName: string; date: Date } {
  ...
  if (day === "hoje") {
    ...
    throw new Error(
      "Dia inválido. Use: hoje, amanha, segunda, terca, quarta, quinta, sexta, sabado, domingo ou semana"
    );
  }
}

// Exemplos de uso:
console.log(getDayDate2("hoje")); // Retorna o dia atual
// console.log(getDayDate("amanha")); // Retorna amanhã
// console.log(getDayDate("quarta")); // Retorna a próxima quarta-feira a partir de hoje
// console.log(getDayDate("semana que vem")); // Retorna a próxima segunda-feira

const currentDate2 = new Date();

const targetDate2 = new Date(currentDate2);
console.log(targetDate2, currentDate2);
