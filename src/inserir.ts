...
//         }
//       });
//       // Skip if nome is missing or empty
...
//       const textToEmbed = `${filme.sinopse || ""} ${filme.genero || ""} ${
//         filme.nome || ""
//       }`.trim();
...
//       const values = [
//         filme.nome.toString(), // Ensure non-null
...
//       const textToEmbed = `${programacao.Status || ""} ${
//         programacao.Segunda || ""
//       } ${programacao.Terça || ""} ${programacao.Quarta || ""} ${
//         programacao.Quinta || ""
//       } ${programacao.Sexta || ""} ${programacao.Sábado || ""} ${
//         programacao.Domingo || ""
//       }`.trim();
//       const embedding = await generateEmbedding(textToEmbed);
...
//   if (args.length < 1) {
//     console.log("Uso: node import_excel.js <caminho_do_arquivo_excel>");
//     return;
//   }
